...
If manual install of these is required:
```npm install @mui/icons-material@^5```
```npm install html2pdf.js```

Note the requirement to install MUI at version 5. Later versions of MUI do not play nicely with the SDK so for now version 5 should be used. MUI is technically optional as it is possible to redo the icons using Ellucian icons but they are used here to give greater variety in the iconography. html2pdf is essential for this extension.

## Configurations required:

- ethosApiKey: The API key for the integration

An application should be created in Ethos Integration and given the credentials to access the authoritative application that owns the Integration API (or wherever you choose to add custom resources). This API Key should be added in Experience Configuration Setup

<img src="../docs/assets/card_configuration.png" width="800">

---
# Ellucian Boilerplate Below
---
